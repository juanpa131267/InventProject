    ...
    <div class="container my-5">
        ...
        <div class="row mb-3">
            ...
            <div class="col-12 col-md-4 mb-2 mb-md-0">
                <a href="{{ url('/administrar-publicaciones') }}" class="btn btn-primary w-100 d-flex align-items-center justify-content-center">
                    <i class="mai-search fs-3 text-white me-2"></i> Volver
                </a>
            </div>

            <!-- Botón Editar -->
            <div class="col-12 col-md-4 mb-2 mb-md-0">
                <a href="{{ url('inmuebles-administrar') }}/{{ $inmueble->id }}/edit" class="btn btn-info w-100 d-flex align-items-center justify-content-center">
                    <i class="mai-pencil fs-3 text-white me-2"></i> Editar
                </a>
            </div>

            <!-- Botón Eliminar -->
            <div class="col-12 col-md-4">
                <form id="deleteForm" action="{{ url('inmuebles-administrar') }}/{{ $inmueble->id }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="button" onclick="confirmDelete()" class="btn btn-danger w-100 d-flex align-items-center justify-content-center">
                        <i class="mai-trash fs-3 text-white me-2"></i> Eliminar
                    </button>
                </form>
            </div>
        </div>
    ...
    function deleteInmueble() {
        ...
        .then(response => {
            if (response.ok) {
                ...
                window.location.href = "{{ url('/administrar-publicaciones') }}";
            } else {
