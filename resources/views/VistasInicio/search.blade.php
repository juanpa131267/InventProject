...
@section('title', 'Buscar Inmuebles')
...
@section('content')
    ...
    <div class="page-banner overlay-dark bg-image" style="background-image: url({{ asset('assetsWelcome/img/aptWindow.jpg') }});">
        <div class="banner-section">
            <div class="container text-center wow fadeInUp">
                <h1 class="font-weight-normal">Residencias disponibles</h1>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function renderInmuebles(inmuebles) {
            ...
            // Filtrar los inmuebles que cumplen con los valores específicos
            ...
            // Si hay inmuebles filtrados, renderizar las cards
            if (filteredInmuebles.length > 0) {
                filteredInmuebles.forEach(item => {
                    ...
                    // Obtener la ubicación desde el modelo mod_Ubicacion
                    ...
                    // Crear tarjeta para cada inmueble
                    const card = `
                ...
                mosaicContainer.innerHTML = '<div class="col-12 text-center">No se encontraron inmuebles.</div>';
            }
        }
